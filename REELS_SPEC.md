...
- 대중 관심도가 높은 순.
- **rank 1은 "정지력" 기준으로 뽑는다(2026-08-08)** — 스크롤을 멈추게 할 힘: 생활 직결(주거·돈·안전·일자리), 충격 수치, 명확한 변화가 있는 뉴스. rank 1이 곧 영상의 훅(hookLine 원천)이므로 "중요하지만 밋밋한" 뉴스보다 "멈추게 하는" 뉴스를 앞세운다. 나머지 2~5위는 기존 기준대로.
